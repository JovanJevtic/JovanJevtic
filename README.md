...
- [Omaška](https://krnetic-demo.jjovan.com) — SaaS for psychotherapy practices: booking, clinical records, billing, client portal · live demo
- Sinapsa — clinic OS for private practices: booking, records, billing, patient portal
...
- Curation Engine — semantic library: embeddings cluster a collection by feeling, not folders
- Five mobile apps on Expo / React Native: Cap or Fact, VibeCheck, Bonds, WhoWatching, Yearprogress
